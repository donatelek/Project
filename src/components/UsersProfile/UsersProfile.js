    ...
    render() {
        return (
            <>
                ...
                <input type="text" />
                <br />
                <label htmlFor="">What programming languages are you using? (select)</label>
                <br />
                <input type="text" />
                <br />
                ...
                <input type="text" />
                <br />
                <label htmlFor="">How much time will you spend on programming every week? (to choose - less than 5h - 5-10 - 11-15 - 16-25 - 26+ ) </label>
                <br />
                <input type="text" />
                <br />
                <label htmlFor="">How long are you programming? (to choose - 1-3months - 4-6 - 7 - 11 - 12+ )</label>
                <br />
                <input type="text" />
                <br />
