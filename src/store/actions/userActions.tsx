...
// export function fetchUsers(data: Auth) {
//   return {
//     type: FETCH_USER,
//     data
//   };
...
// export function fetchLogin(data: Auth) {
//   return {
//     type: USER_LOGIN,
//     data
//   };
...
// export function fetchRegister(data: Auth) {
//   return {
//     type: USER_REGISTER,
//     data
//   };
...
// export const userValidationLogin = (email: string, password: string) => (
//   dispatch: Dispatch
// ) => {
...
// export const userValidationRegister = (email: string, password: string) => (
//   dispatch: Dispatch
// ) => {
